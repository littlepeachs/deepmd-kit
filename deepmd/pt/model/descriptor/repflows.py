    ...
    def forward(
        ...
        if stage_size is not None and stage_index is not None:
            ...
            for idx in range(start, end):
                ...
                #     }
                #     with open(f'/aisi/mnt/data_nas/liwentao/devel_workspace/deepmd-kit-pp/temp_input/debug_inputs_{idx}_pp.pkl', 'wb') as f:
                #         pickle.dump(debug_inputs, f)
                print(f"layer {idx} output:")
                print(f"node_ebd: {node_ebd_ext[0,:5,:5]}")
                ...
                #         'angle_ebd': angle_ebd,
                #     }
                #     with open(f'/aisi/mnt/data_nas/liwentao/devel_workspace/deepmd-kit-pp/temp_input/debug_outputs_{idx}_pp.pkl', 'wb') as f:
                #         pickle.dump(debug_outputs, f)
            ...
            for idx, ll in enumerate(self.layers):
                ...
                #         'angle_index': angle_index,
                #     }
                #     with open(f'/aisi/mnt/data_nas/liwentao/devel_workspace/deepmd-kit-pp/temp_input/debug_inputs_{idx}_npp.pkl', 'wb') as f:
                #         pickle.dump(debug_inputs, f)  
                print(f"layer {idx} output:")
                print(f"node_ebd: {node_ebd[0,:5,:5]}")
                ...
                #         'angle_ebd': angle_ebd,
                #     }
                #     with open(f'/aisi/mnt/data_nas/liwentao/devel_workspace/deepmd-kit-pp/temp_input/debug_outputs_{idx}_npp.pkl', 'wb') as f:
                #         pickle.dump(debug_outputs, f)
